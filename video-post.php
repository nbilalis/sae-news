                    ...
                    <div class="post-details-content d-flex">
                        ...
                        <div class="blog-content">
                            ...
                            if (isset($_GET["id"]) && !empty(trim($_GET["id"]))):
                                ...
                                $sql = "SELECT p.id, p.title, body, views, likes, date, c.title AS category, u.username
                                        FROM posts p
                                ...
                                if ($results = $conn->query($sql)):
                                    if ($row = $results->fetch_assoc()):
                                        ...
                                        $sql = "UPDATE posts SET views = IFNULL(views, 0) + 1 WHERE id = ?";
                            ...
                            <div class="post-content mt-0">
                                <a href="#" class="post-cata cata-sm cata-danger"><?= $row["category"] ?></a>
                                <a href="single-post.html" class="post-title mb-2"><?= $row["title"] ?></a>

                                <div class="d-flex justify-content-between mb-30">
                                    <div class="post-meta d-flex align-items-center">
                                        <a href="#" class="post-author">By <?= $row["username"] ?></a>
                                        <i class="fa fa-circle" aria-hidden="true"></i>
                                        <a href="#" class="post-date"><?= date("D M Y") ?></a>
                                    </div>
                                    <div class="post-meta d-flex">
